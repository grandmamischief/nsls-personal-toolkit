...
name: obsidian-setup
description: >-
  Set up a new Obsidian knowledge base matching the NSLS builder pattern.
  Walks through the builder onboarding interview, vault creation, folder
  structure, templates, plugin config, and connects data sources (Familiar,
  Fathom, Slack, Gmail, Asana). Trigger with /obsidian-setup or phrases like
